...
class UpgradeModel extends BaseModel implements DatabaseAwareInterface
{
	...
	private const REMOVE_FROM_ALL_VERSIONS = [
		'files'   => [
			JPATH_SITE . '/components/com_ars/tmpl/Releases/release.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Releases/category.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Releases/default.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Update/all.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Update/ini.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Update/category.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Update/stream.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Latest/generic.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Latest/latest.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Latest/item.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Latest/category.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/DownloadIDLabels/form.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/DownloadIDLabels/default_dlid.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/DownloadIDLabels/default_publish.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/DownloadIDLabels/default.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Items/release.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Items/item.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Items/default_environments.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Items/modal.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Items/default.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Categories/bleedingedge.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Categories/generic.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Categories/category.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Categories/customrepo.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Categories/normal.blade.php',
			JPATH_SITE . '/components/com_ars/tmpl/Categories/repository.blade.php',


			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/ErrorPages/hhvm.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/ErrorPages/fof.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/ErrorPages/fef.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/ErrorPages/wrongphp.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/ErrorPages/errorhandler.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Releases/form.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Releases/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/UpdateStreams/form.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/UpdateStreams/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Environments/form.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Environments/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/DownloadIDLabels/form.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/DownloadIDLabels/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Logs/default.j4.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Logs/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/AutoDescriptions/form.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/AutoDescriptions/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Items/form.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_ars/tmpl/Items/modal.blade.php',
